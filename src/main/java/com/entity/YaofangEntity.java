...
public class YaofangEntity<T> implements Serializable {
	...
	private String yaofangzhanghao;
	 ...
	 * 设置：药房账号
	 */
	public void setYaofangzhanghao(String yaofangzhanghao) {
		this.yaofangzhanghao = yaofangzhanghao;
	}
	/**
	 * 获取：药房账号
	 */
	public String getYaofangzhanghao() {
		return yaofangzhanghao;
	}
	/**
	 * 设置：密码
	 */
