...
public class ZhenduanxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ZhenduanxinxiEntity zhenduanxinxi, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ZhenduanxinxiEntity zhenduanxinxi, HttpServletRequest request){
        EntityWrapper<ZhenduanxinxiEntity> ew = new EntityWrapper<ZhenduanxinxiEntity>();
    	PageUtils page = zhenduanxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, zhenduanxinxi), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
