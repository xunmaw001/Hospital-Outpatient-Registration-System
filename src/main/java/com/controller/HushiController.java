...
public class HushiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		HushiEntity user = hushiService.selectOne(new EntityWrapper<HushiEntity>().eq("hushizhanghao", username));
    ...
    public R register(@RequestBody HushiEntity hushi){
    	...
    	HushiEntity user = hushiService.selectOne(new EntityWrapper<HushiEntity>().eq("hushizhanghao", hushi.getHushizhanghao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,HushiEntity hushi, HttpServletRequest request){
