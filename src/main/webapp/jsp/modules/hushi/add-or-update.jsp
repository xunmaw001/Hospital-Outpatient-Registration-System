...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑护士</span></li>
							</ol>
						</div>
					</div>
				</div>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>护士账号</label>
										<input id="hushizhanghao" name="hushizhanghao" class="form-control" placeholder="护士账号">
									</div>
									<div class="form-group col-md-6">
										<label>密码</label>
									...
									<div class="form-group col-md-6">
										<label>护士姓名</label>
										<input id="hushixingming" name="hushixingming" class="form-control" placeholder="护士姓名">
									</div>
									<div class="form-group col-md-6">
										<label>性别</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#hushizhanghao").val(ruleForm.hushizhanghao);	
			$("#mima").val(ruleForm.mima);	
			$("#hushixingming").val(ruleForm.hushixingming);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.hushizhanghao != null && res.data.hushizhanghao != ''){

					$("#hushizhanghao").val(res.data.hushizhanghao);
					}
					if(res.data != null && res.data != '' && res.data.mima != null && res.data.mima != ''){

					$("#mima").val(res.data.mima);
					}
					if(res.data != null && res.data != '' && res.data.hushixingming != null && res.data.hushixingming != ''){

					$("#hushixingming").val(res.data.hushixingming);
					}
