					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑药房</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">药房信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>药房账号</label>
										<input id="yaofangzhanghao" name="yaofangzhanghao" class="form-control" placeholder="药房账号">
									</div>
									<div class="form-group col-md-6">
										<label>密码</label>
									...
									<div class="form-group col-md-6">
										<label>负责人姓名</label>
										<input id="fuzerenxingming" name="fuzerenxingming" class="form-control" placeholder="负责人姓名">
									</div>
									<div class="form-group col-md-6">
										<label>性别</label>
	...
	<script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("yaofang/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function dataBind(){
			...
			$("#yaofangzhanghao").val(ruleForm.yaofangzhanghao);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yaofangzhanghao != null && res.data.yaofangzhanghao != ''){

					$("#yaofangzhanghao").val(res.data.yaofangzhanghao);
					}
